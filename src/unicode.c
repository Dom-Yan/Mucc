...
// unicode.c - SUPPORT
//
// UTF-8 encoding/decoding and Unicode rules for identifiers.
//============================================================================
...
//---------- Which characters may appear in identifiers ----------------------
...
bool is_ident1(uint32_t c) {
  // Fast path for ASCII, which is nearly all C source.
  if (c < 128)
...
//---------- Display width (lines up the ^ in error messages) ----------------
